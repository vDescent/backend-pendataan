        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BinusianId = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    Gender = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ActiveSemester = table.Column<int>(type: "int", nullable: false),
                    BinusianStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ParentGuardianPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
